...
.aboutusright ul {padding-left: 0;}
.aboutusright ul li {
    list-style: none;
    font-size: 19px;
    margin-bottom: 5px;
...
right: 5px;">
				<div class="selectionBlock">
					...
					</h3><span class="formNote" style="width: 90%;">
						A vast majority of our clients opt to explore 2-3 destinations in a single trip. The most
						popular duos and trios are:
					...
					<div class="checkboxLabel destination">
						<input type="checkbox" value="South Korea" id="South Korea" name="destination[]">
						<label for="South Korea" class="updatedestination">
							South Korea
						</label>
					</div>
					<div class="checkboxLabel destination">
				...
				<div class="selectionBlock">
					<p style="margin-bottom: 5px; margin-top: 10px;">Any other
			...
			<div id="inquiryBox">
				<div class="selectionBlock">
					...
					<div class="checkboxLabel">
						<input type="radio" value="Tell me when's best" id="yet" name="trip_date">
					...
					<div class="trip_date_length" id="tripDateBlock" style="display: none">
						<h4 id="tripDateDesc">Select your estimated travel date and trip length (days).</h4>
						<div id="dateSelectionBlock">
							...
							<select class="country_code" id="expectedMonth" name="expected_month"
								style="width: 360px; height: 45px; float: left; display: block;">
						...
						<div id="expectedTravelDateBlock" style="display: none">
							...
							<textarea id="date_requirements" name="date_requirements" style="resize:none;height: 50px;"></textarea>
						</div>
					</div>
				...
				<div class="selectionBlock">
					...
					<div class="selectHotl">
						<div class="optionLable">
							...
							<label for="fiveStar" class="hotelText fivestar">
								Deluxe
						...
						<div class="optionLable">
							...
							<label for="fourStar" class="hotelText fourstar">
								Handpicked comfort
								<div class="selectionMemo">
									USD 100-200 / night
								</div>
						...
						<div class="optionLable">
							...
							<label for="threeStar" class="hotelText threestar">
								Standard
								<div class="selectionMemo">
									USD 70-100 / night
								</div>
						...
						<div class="optionLable">
							...
							<label for="Self" class="hotelText" style="padding-top: 15px; height: 25px;">
								Book on my own
							</label>
						</div>
					</div>
					...
					<textarea id="hotel_requirements" name="hotel_requirements" style="resize:none;height: 30px;"></textarea>
				</div>
			</div>
			...
			<div id="inquiryBox">
				<div class="selectionBlock">
					...
					<div id="group_error_msg" class="hidden">(Please
						select at least one option.)</div>
					<div class="genderSelection" style="display: flex;">
					...
					<div id="adultBlock" style="display: none">
						...
						<div class="peopleSelect" style="width: 210px;">
							<select class="country_code" id="adult_18_plus" name="adult_18_plus" style="width: 70px;
    height: 40px;
    float: left;
    display: inline-block;
    margin-right: 10px;">
...
">people</p>
					...
					<div id="childrenBlock" style="display: none">
						<h4 style="padding: 0; font-weight:600;margin-top: 15px;">Children number (age at time of trip)
						</h4>
						<div class="peopleSelect" style="width: 210px;">
							<span class="formMemo">
								10-17 yrs old
							</span>
							<select class="country_code" id="teenagerNumber" name="teenager_10_17" style="width: 70px;
    height: 40px;
    float: left;
    display: inline-block;
    margin-right: 10px;">
...
">people</p>
						...
						<div class="peopleSelect" style="width: 210px;">
							...
							<select class="country_code" id="childrenNumber" name="children_3_9" style="width: 70px;
    height: 40px;
    float: left;
    display: inline-block;
    margin-right: 10px;">
...
">people</p>
						...
						<div class="peopleSelect" style="width: 210px;">
							...
							<select class="country_code" id="infantNumber" name="infant_0_2" style="width: 70px;
    height: 40px;
    float: left;
    display: inline-block;
    margin-right: 10px;">
...
">people</p>
			...
			<div id="inquiryBox">
				...
				<span id="name_error_msg" class="hidden">(Please fill out this
					field.)</span>
				<div class="inputTerm">
					<input type="text" name="name" required="" class="name" placeholder="* Your name">
				</div>
				...
				<div class="inputTerm">
					<input type="email" name="email" id="email" required="" class="email" placeholder="* Your email address">
				...
				<div class="inputTerm" style="margin-bottom: -10px;">
					...
					<input type="tel" name="PhoneNo" id="contactInfo" required="" class="phone" placeholder="* Your phone number">
			...
			<div id="inquiryBox">
				<div class="selectionBlock">
					...
					<span class="formNote">E.g.: <br>
						...
						3. My special requests for hotel/transportation/food are…
					</span>
...
font-weight: 600;
font-style: italic; color:#202020;">(Optional) This is a big trip for:</p>
			...
			<div class="table-responsive" style="width: 1100px; margin: 0 auto 80px auto;" rel="nofollow">
				<table>
				  <tbody>
					<tr>
					  <td>
