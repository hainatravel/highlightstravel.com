...
<head>
	...
	<!--@OG:IMAGE@-->
	<link rel="canonical" href="https://www.asiahighlights.com/tailor-make-your-trip-easy">
...
h4 { font-size: 23px; font-weight: 400; margin-bottom: 10px;}
	body {
		margin: 0;
		font-family: Calibri;
	}
...
.age_range {     display: inline-block;
width: 475px;
position: relative;
top: -55px;}
#childrenBlock {margin-top: -50px;}
	.minaddBtn {
		background: #FFF;
		border: 1px solid #d1d1d1;
		border-radius: 4px;
...
">
					...
					<div class="preface">
						Tell us your requirements and get a reply within 24 hours.
					</div>
					<div class="selectionBlock">


						<h3 id="destination_select" style="    margin-top: 30px;">
							<em>*</em> Your Preferred Destination(s): choose a country or multiple countries
						</h3>
						<p>More than <em><strong>95%</strong></em> of our customers choose to visit 2–3 Asian countries
							in one trip. The most popular combos are:</p>
						<ul class="InfoList">
							<li>Thailand, Vietnam, Cambodia (12-20 days)</li>
							<li>Thailand, Vietnam, Cambodia, Laos (15-25 days)</li>
							
							<li>Vietnam, Cambodia (10-15 days)</li>
							<li>Thailand, Cambodia (10-15 days)</li>
						</ul>
						<div id="destination_error_msg" style="color:#a31022;font-size:18px;" class="hidden">(Please
					...
					<!--
					<div class="selectionBlock">
						<p style="    margin-bottom: 10px; margin-top: 35px;">Any specific cities / destinations or
							other Asian countries you'd like in this trip...(optional)</p>

						<input name="other_destinations" style="height: 40px;
								width: 95%;
								border: 1px solid #d1d1d1;
								border-radius: 4px;
								font-size: 19px;
				...
				-->
					<div class="selectionBlock">
						<h3 id="hotelselect">
							<em>*</em> Select Your Hotel Preference
						</h3>
						<div id="hotel_error_msg" style="color:#ad1818;font-size:18px; " class="hidden">(Please select
							one option. It can be changed later.)</div>
						<span class="formNote">
							Hotel prices in Japan are at least doubled based on the suggested rates below.
						</span>
						...
						<div class="checkYes" style="margin-top: -15px;display: flex;">

							<label for="AMEX"><input type="checkbox" class="checkBorder"
									name="use_AMEX_points_to_book_hotels" value="Yes" id="AMEX">I will use my AMEX
								points to book some hotels for this trip. </label>
						</div>
					</div>
					<div class="selectionBlock">
						<h3 id="travelGroupHeader">
							<em>*</em> Select Number in Your Group 
						</h3>
					<span id="group_error_msg" style="color:#ad1818;font-size:18px;" class="hidden">(Please fill out this field.)</span>
...
">When you plan to take the trip:</p>
						<div class="peopleSelect" style="width: 262px;">
							<h4>
								Adults (≥18 years old)
							</h4>
							<div class="numberBtn">
            ...
            <div id="childrenBlock" style="display: none">
						<h4>Children</h4>					
						<div class="peopleSelect" style="width: 244px;">
							<span class="formMemo">
								10-17 years old
							</span>
							<div class="numberBtn">
						...
						<div class="peopleSelect" style="width: 245px;">
							<span class="formMemo">
								0-2 years old
							</span>
							<div class="numberBtn">
					...
					<div class="selectionBlock">
						<h3 id="dateselect">
							<em>*</em> Select Your Date of Arrival<span id="date_error_msg" style="color:#ad1818;font-size:18px;"
					...
					<div class="selectionBlock">
						<h3 id="tripLengthTitle">
							<em>*</em> Select Your Trip Length (days) <span id="trip_length_error_msg" style="color:#ad1818;font-size:18px;"
								class="hidden">(Please fill out this field.)</span>
						</h3>
					...
					<div class="selectionBlock">
						<h3>
							<em>*</em> Tell us more to help us put together your ideal journey.
						</h3>
						<div id="requirement_error_msg" style="color:#ad1818;font-size:18px;" class="hidden">(Please
							specify your requests.)</div>
							<p style="margin: 0;font-size: 18px;">E.g. cities you'd like to visit, activities you'd like to take, budget, food/accommodation/transportation requirements, or any other requests…</p>
						<textarea id="additionalrequirements" name="additional_requirements" style="resize:none;"
							></textarea>
							<p style="margin-bottom: 0;">In this trip I am interested in these:</p>
							...
							<div class="travelStyle">
								<input type="checkbox" value="Adventure" id="Adventure" name="interests[]">
								<label for="Adventure" data-clickable>
									<div class="smallTag">
							...
							<div class="travelStyle">
								<input type="checkbox" value="Trekking" id="Trekking" name="interests[]">
								<label for="Trekking" data-clickable>
									<div class="smallTag">
										<div class="styleText">Trekking</div>
									</div>
								</label>
							</div>
							<div class="travelStyle">
								<input type="checkbox" value="Lantern Festival" id="Lantern" name="interests[]">
								<label for="Lantern" data-clickable>
									<div class="smallTag">
										<div class="styleText">Lantern Festival</div>
									</div>
								</label>
							</div>
							<div class="travelStyle">
								<input type="checkbox" value="Food" id="Food" name="interests[]">
							...
							<div class="travelStyle">
								<input type="checkbox" value="Animal sanctuary" id="Animal sanctuary" name="interests[]">
								<label for="Animal sanctuary" data-clickable>
									<div class="smallTag">
										<div class="styleText">Animal sanctuary</div>
									</div>
								</label>
							</div>
							<div class="travelStyle">
								<input type="checkbox" value="Theme parks" id="Theme parks" name="interests[]">
								<label for="Theme parks" data-clickable>
									<div class="smallTag">
										<div class="styleText">Theme parks</div>
									</div>
								</label>
							</div>
							<div class="travelStyle">
								<input type="checkbox" value="Island hopping" id="Island hopping" name="interests[]">
								<label for="Island hopping" data-clickable>
									<div class="smallTag">
										<div class="styleText">Island hopping</div>
									</div>
								</label>
							</div>
							<p style="margin-bottom: 0;">This is a big trip for:</p>
								<div class="travelStyle">
							...
							<div class="travelStyle">
								<input type="checkbox" value="Family reunion" id="familyreunion" name="interests[]">
								<label for="familyreunion" data-clickable>
									<div class="smallTag">
							...
							<div class="travelStyle">
								<input type="checkbox" value="Summer vacation" id="Summer vacation" name="interests[]">
								<label for="Summer vacation" data-clickable>
									<div class="smallTag">
										<div class="styleText">Summer vacation</div>
									</div>
								</label>
							</div>
							<div class="travelStyle">
								<input type="checkbox" value="first timer" id="first timer" name="interests[]">
								<label for="first timer" data-clickable>
									<div class="smallTag">
										<div class="styleText">First-timer</div>
									</div>
								</label>
							</div>
							<p style="margin-bottom: 0;">I want this trip to be:</p>
							<div class="travelStyle">
								<input type="checkbox" value="kids-friendly" id="kids-friendly" name="interests[]">
								<label for="kids-friendly" data-clickable>
									<div class="smallTag">
										<div class="styleText">Kids-friendly</div>
									</div>
								</label>
							</div>
							<div class="travelStyle">
								<input type="checkbox" value="Physical-friendly" id="Physical-friendly" name="interests[]">
								<label for="Physical-friendly" data-clickable>
									<div class="smallTag">
										<div class="styleText">Physical-friendly</div>
									</div>
								</label>
							</div>
							<div class="travelStyle">
								<input type="checkbox" value="Budget-friendly" id="Budget-friendly" name="interests[]">
								<label for="Budget-friendly" data-clickable>
									<div class="smallTag">
										<div class="styleText">Budget-friendly</div>
									</div>
								</label>
							</div>
							<div class="travelStyle">
								<input type="checkbox" value="Off-the-beaten" id="Off-the-beaten" name="interests[]">
								<label for="Off-the-beaten" data-clickable>
									<div class="smallTag">
										<div class="styleText">Off-the-beaten</div>
									</div>
								</label>
							</div>
							<div class="travelStyle">
								<input type="checkbox" value="Slow-pace" id="Slow-pace" name="interests[]">
								<label for="Slow-pace" data-clickable>
									<div class="smallTag">
										<div class="styleText">Slow-pace</div>
									</div>
								</label>
							</div>
				...
				<div id="inquiryBox" style="    margin-bottom: 180px;     margin-top: 10px;">
					...
					<p>We will only use your phone number and other data in accordance with data protection regulations
						(the GDPR). See our <a href="/privacy" target="_blank"
					...
					<div class="inputTerm" style="margin-bottom: -10px;">
						...
						<input type="text" name="PhoneNo" id='contactInfo' required style="width: 53%;"/>
						<label style="width: 53%; left: 325px;">
							* Phone number
						</label>
					</div>
					<div class="formMemo" style="font-size: 16px; color: #999; display: block; margin-top: 15px;">
						Having a phone number, especially with WhatsApp/iMessage capability will improve communication
						efficiency.
					</div>
					<p style="
					margin-top: 0;
